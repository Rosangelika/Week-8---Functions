...
namespace FunctionsReturnAndArraysFromFile
{
    class Program
    {
        ...
        private static void DisplayRandomFood()
        {
            ...
            Console.WriteLine($"Computer picked food: {randomFood}");
        ...
        private static void DisplayRandomDrink()
        {
            ...
            Console.WriteLine($"Computer picked drink: {randomDrink}");
        }
        private static void DisplayRandomMovie()
        {
            ...
            Console.WriteLine($"Computer picked movie: {randomMovie}");
        }
